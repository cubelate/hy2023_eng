$(document).ready(function () {
   ...
   var teamData = [
    {name:'Sun Yelin',position:'Founding Partner',imgName:'teamerph01.png',des:[
        'Mr. Sun Yelin possesses extensive experience in the IT industry and investment. He has held senior vice president positions in globally renowned technology companies. During his tenure at a leading global technology company, he served as the Director of the Beijing Research Institute, Global President of Services, Optical Network Product Line President, Commonwealth of Independent States (CIS) Region, and Operations and Regional Management Department President. He has accumulated comprehensive skills in innovation and product portfolio management, investment decision-making, service management, international business expansion, global, regional management, leadership enhancement, and corporate transformation management. Furthermore, he has a wealth of industrial resources.',
    ...
    {name:'Wang Chongru',position:'Executive Director',imgName:'teamerph07.png', des:[
        `Mr. Wang Chongru mainly focuses on investment in areas such as AI, semiconductors, and new energy. Before joining the company, he participated in establishing Huishoubao, a leading mobile and digital device recycling platform strategically invested by Alibaba. He served as the Product Director and was responsible for overall product planning and implementation. Before that, he worked as a Product Manager at Tencent. Through his past work and entrepreneurial experiences, Mr. Wang Chongru has accumulated rich experience in product and system design. During his tenure at Tencent, he completed nearly 20 related product patents.`,
    ...
    {name:'Han Tao',position:'Investment Director',imgName:'teamerph12.png', des:[
